...
/* This structure represents data associated with a line of code or an instruction */
struct line_data {
    ...
    int args; /* Stores the number of arguments or operands expected by the instruction. */
...
/**
 * @brief This function get the instruction code and number of arguments from a word.
 * @param p Represents the instruction structure where the instruction code and number of arguments will be stored.
